...
//											
//		$Description:	Talk about ABC's and pure virtual functions
//											
//		$Date:		9/23/01						
//											
//**********************************************************************************//
...
Files:  	main.cpp (The Source File containing the actual code)
	Shape.cpp (The Source File containing the "shape's implementation")
	Shape.h (The Header File containing the "shape's definitions")
