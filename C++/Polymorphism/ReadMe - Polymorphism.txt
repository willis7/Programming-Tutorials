...
//											
//		$Description:	Defines "polymorphism" and goes over "virtual functions"
//											
//		$Date:		8/12/01						
//											
//**********************************************************************************//
...
Files:  	main.cpp (The Source File containing the actual code)
	Shape.cpp (The Source File containing the "shape classes' implementations")
	Shape.h (The Header File containing the "shape classes' definitions")
	Polymorphism.vcproj  (The VC++ Project File holding the project info)
	Polymorphism.sln  (The Solution File holding the solution info)
