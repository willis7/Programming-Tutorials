...
//		$Program:		Macros
//			 
//		$Description:	Everything you would want to know about "macros"	 
//						 
//		$Date:		2/08/02			 
//		 
//*******************************************************************************//
...
Files:  	main.cpp (The Source File containing the actual code)
	Macros.vcproj  (The VC++ Project File holding the project info)
	Macros.sln  (The Solution File holding the solution info)
