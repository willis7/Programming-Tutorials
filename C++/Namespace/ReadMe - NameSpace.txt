...
//		$Program:		NameSpace
//											
//		$Description:	Goes over "namespaces"
//											
//		$Date:		10/15/01						
//											
//**********************************************************************************//
...
Files:  	main.cpp (The Source File containing the "main" code)
	NameSpace.vcproj  (The VC++ Project File holding the project info)
	NameSpace.sln  (The Solution File holding the solution info)
