...
//		$Program:		threads2					
//											
//		$Description:	Introduction to mutex's and a critical section
//											
//		$Date:		9/1/03						
//											
//**********************************************************************************//
...
Files:  	main.cpp (The Source File containing the "main" code)
	threads2.vcproj  (The VC++ Project File holding the project info)
	threads2.sln  (The Solution File holding the solution info)
