...
//		$Program:		threads4					
//											
//		$Description:	Shows how to create a simple Win32 thread class
//											
//		$Date:		9/21/03						
//											
//**********************************************************************************//
...
Files:  	main.cpp (The Source File containing the "main" code)
	threads4.vcproj  (The VC++ Project File holding the project info)
	threads4.sln  (The Solution File holding the solution info)
