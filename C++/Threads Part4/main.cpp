...
int main() {
	...
	// lets make an instance of our thread object
	CPrintSomethingThread theThread;

	// tell the thread to begin
	theThread.begin();

	// wait until we press ENTER on the keyboard
	kbhit();
...
// the thread would there?  Well if you made the programmer write a function that just performed ONE
