...
#include <iostream>
#include <time.h> // We need this for the function time() so we can seed the random number
				 // generator
...
int main()
{
	srand(time(NULL)); // First thing we'll do is seed the random number generator
