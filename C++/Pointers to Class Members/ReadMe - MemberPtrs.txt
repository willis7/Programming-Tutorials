...
//		$Program:		MemberPtrs						
//											
//		$Description:	Discusses pointers to member variables/functions
//											
//		$Date:		8/25/02						
//											
//**********************************************************************************//
...
Files:  	main.cpp (The Source File containing the "main" code)
	player.cpp (The Source File containing the "player's implementation")
	player.h (The Header File containing the "player's definitions")
	MemberPtrs.vcproj  (The VC++ Project File holding the project info)
	MemberPtrs.sln  (The Solution File holding the solution info)
