...
//////////// *** NEW *** ////////// *** NEW *** ///////////// *** NEW *** ////////////////////
	...
	// exit.  This makes it so if want to make a whole side of a map an exit to another
...
// scrolling for larger maps.  You will most likely want to add action 
// point tiles too (like exits).  For instance, an action point will just 
// store a position and #ID so when the character walks over it, it will 
// be used to do unique actions like traps or game over / game won places 
// or cinematics (such as pre-programmed scripts or functions should run).  
// These are very necessary. Let me know if you have any other cool ideas 
// or need help implementing any of these ideas.
//
