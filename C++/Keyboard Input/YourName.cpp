...
void main()						// This creates our "main"
{								// The "{" signifies the start of the function
	string szName;				// Here we create something called a "variable".
								...
								// In my memory so I can remember it and say, "Hello <your name>".  Computers works the same way
								...
								// We call our string variable, "szName".  It doesn't have to be called that, it could be called "name"
								// But this is a programming convention that you will find.  "sz" stands for string (for some crazy reason).
								// So, in order to make our variables readable and have clean code, we label them line this.
								// When your code becomes huge, you can always scroll up to where the variable was created and see what
								// Type is was, an int, double, float, or string, etc.. so we label them accordingly.
								...
								// any special headers (like <string>)
	...
	cin >> szName;				// We use "cin" (console input) to read in input from the keyboard.
								// The syntax is opposite from cout, ">>".  We give "cin" a variable to store the name, "szName"
								// So now, what ever name the user types in, will be stored and can then be access from the variable "szName".
								// If you get confused with the << and >>,  Just think of it like this:
								// We are pushing text out to the screen with cout so we use << which is going AWAY from cout,
	...
	cout << "Hello " << szName << endl;
								...
								// Then we display what ever is stored in the variable "szName"...
...
// Like this:   cout << "Hello " << szName << " " << szName << " " << szName << "!" << endl;
...
// If any of this didn't make sense, refer to (1) HelloWorld.
