...
//		$Program:		Print		     
//										 
//		$Description:	Calls a function from a DLL (PrintDLL.dll) 
//										 
//		$Date:		10/20/01					 
//				
//***********************************************************************
...
Files:  	main.cpp (The Source File containing the actual code)
	print.h (The Header File containing the "print DLL definitions")
	FPArray.vcproj  (The VC++ Project File holding the project info)
	FPArray.sln  (The Solution File holding the solution info)

Libraries:		PrintDLL.dll   (The "Print" Dynamic Link Library needed in order to run the program)
		PrintDLL.lib (The "Print" Library needed to compile the program)
		**NOTE** Both libraries were created by the project in the PrintDLL folder
