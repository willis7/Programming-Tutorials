...
Files:  	print.cpp (The Source File containing the implementation of the DLL)
	print.h (The Header File containing the definition of the DLL)
	PrintDLL.vcproj  (The VC++ Project File holding the project info)
	PrintDLL.sln  (The Solution File holding the solution info)
