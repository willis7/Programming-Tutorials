...
/*
	...
	Is the whole concept behind an if statement starting to make sense???  Well read 
...
using namespace std; // Here we make sure we using the standard namespace (again this 
...
int main()
{
	...
	{			// to implement an if statement:
				...
				// If "some condition" is NOT TRUE (ie false) NONE of the code in the {}'s
				// will be executed.
	...
	// If "num" is negative, same thing -- "num is negative" will be print to the screen
