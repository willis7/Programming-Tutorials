...
// is what the process' are for.  Your computer manages the processes allowing them each time for
...
void main() {
	...
	// is a handy function that will wait for an object to finish what it was doing before continuing to execute.   Its
