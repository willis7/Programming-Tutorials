...
//		$Program:		threads1					
//											
//		$Description:	Introduction to a threaded application
//											
//		$Date:		9/1/03						
//											
//**********************************************************************************//
...
Files:  	main.cpp (The Source File containing the "main" code)
	threads1.vcproj  (The VC++ Project File holding the project info)
	threads1.sln  (The Solution File holding the solution info)
