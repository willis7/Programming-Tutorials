...
Files:  	WritingFiles.cpp (The Source File containing the actual code)
	WritingToFiles.vcproj  (The VC++ Project File holding the project info)
	WritingToFiles.sln  (The Solution File holding the solution info)
