...
int main()
{
	...
	output_handle = GetStdHandle(STD_OUTPUT_HANDLE); // Get our output handle (ie handle to 
	...
	while(1)
	{
		...
		// we'll do a little math to make sure that this string of 10 characters is always 
		// centered
		...
		{	
			// Reterive the ASCII char that was pressed
