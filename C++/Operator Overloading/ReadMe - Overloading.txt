...
//		$Program:		Overloading						
//											
//		$Description:	Goes over Operator Overloading
//											
//		$Date:		7/8/01						
//											
//**********************************************************************************//
...
Files:  	main.cpp (The Source File containing the "main" code)
	Vector.cpp (The Source File containing the "shape's implementation")
	Vector.h (The Header File containing the "shape's definitions")
	Overloading.vcproj  (The VC++ Project File holding the project info)
	Overloading.sln  (The Solution File holding the solution info)
