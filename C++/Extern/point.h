...
// Here's some simple functions to interact with out point struct.
...
// us a dual declaration of the same variable which is bad (ie you can't declare two 
...
// file and allow it to be used by multiple other files.
//SPoint notExternedPoint; // *** COMMENT THIS IN TO SEE A COMPILER ERROR ***
