...
/*
	...
	We know that .c and .cpp files compile differently (ie you can only declare variables at 
	...
	the keyword "extern".  However if you're writing portable, very large project, or hyper
