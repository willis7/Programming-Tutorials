...
//		$Program:		Extern					
//											
//		$Description:	Goes over the keyword "extern"
//											
//		$Date:		2/09/03						
//											
//**********************************************************************************//
...
Files:  	main.cpp  (The Source File containing the "main" code)
	point.cpp.h (The Source File containing the "point" code)
	point.cpp (The Header File containing the "point" definitions)
	Extern.vcproj  (The VC++ Project File holding the project info)
	Extern.sln  (The Solution File holding the solution info)
