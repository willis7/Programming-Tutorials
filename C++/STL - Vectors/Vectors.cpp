...
int main()									// Beginning of the program
{
	...
	for(i = 0; i < vInventory.size(); i++)
	{
		...
		// exactly like an array of tItem's.  We just specify the index
...
// with ease.  Once again, take a look at "stack", "queue" and "list" for more list
// classes.  It depends on what you want to do.  I usually just stick with vectors.
//
// * Remember, these list's free themselves.  You never need to free or delete anything! *
//
// Enjoy!
//
