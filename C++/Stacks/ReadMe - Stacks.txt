...
//		$Program:		Stacks						
//											
//		$Description:	Defines a stack and implements a stack 
//											
//		$Date:		6/10/01						
//											
//**********************************************************************************//
...
Files:  	main.cpp (The Source File containing the actual code)
	stack_class.cpp (The Source File containing the "stack's implementation")
	stack_class.h (The Header File containing the "stack's definitions")
