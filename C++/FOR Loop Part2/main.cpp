...
// of "function definitions" that a some smart people wrote for us to use in our
// programs.  Now USUSALLY "header files" end in a .h -- But this is A NEW type of header file
