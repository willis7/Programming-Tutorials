...
//								 
//		$Program:		ConstKeyword
//								 
//		$Description:	Everything you would want to know about "const" :))	 
//							 
//		$Date:		2/18/02	
//					 
//*******************************************************************************//
...
Files:  	main.cpp (The Source File containing the actual code)
	ConstKeyword.vcproj  (The VC++ Project File holding the project info)
	ConstKeyword.sln  (The Solution File holding the solution info)
