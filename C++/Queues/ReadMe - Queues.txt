...
//		$Program:		Queues					
//											
//		$Description:	Makes a "Queue Class" and defines what a "queue" is 
//											
//		$Date:		6/20/01						
//											
//**********************************************************************************//
...
Files:  	main.cpp (The Source File containing the "main" code)
	queue_class.cpp (The Source File containing the "queue's implementation")
	queue_class.h (The Header File containing the "queue's definitions")
