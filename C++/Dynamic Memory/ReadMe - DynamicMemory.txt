...
//											
//		$Description:	Creates dynamic memory -- Frees dynamic memory 
//											
//		$Date:		6/4/01						
//											
//**********************************************************************************//
...
Files:  	main.cpp (The Source File containing the actual code)
	DynamicMemory.vcproj  (The VC++ Project File holding the project info)
	DynamicMemory.sln  (The Solution File holding the solution info)
	TheTextFile.txt (A text file for reading)
