...
//		$Program:		Linked List
//											
//		$Description:	An overview of linked lists
//											
//		$Date:		7/31/01						
//											
//**********************************************************************************//
...
Files:  	main.cpp (The Source File containing the actual code)
	LinkedList.cpp (The Source File containing the "linked list implementation")
	LinkedList.h (The Header File containing the "linked list definition")
	Linked List.vcproj  (The VC++ Project File holding the project info)
	Linked List.sln  (The Solution File holding the solution info)
