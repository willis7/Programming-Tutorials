...
//		$Program:		Classes						
//											
//		$Description:	Discusses the "this" pointer
//											
//		$Date:		8/26/01						
//											
//**********************************************************************************//
...
Files:  	main.cpp (The Source File containing the actual code)
	Point_Class.cpp (The Source File containing the "point class implementation")
	Point_Class.h (The Header File containing the "point class definition")
