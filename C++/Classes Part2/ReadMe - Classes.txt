...
//		$Program:		Classes						
//											
//		$Description:	A more indepth look at classes 
//											
//		$Date:		6/8/01						
//											
//**********************************************************************************//
...
Files:  	main.cpp (The Source File containing the actual code)
	Point_Class.cpp (The Source File containing the "point's implementation")
	Point_Class.h (The Header File containing the "point's class definition")
	Classes.vcproj  (The VC++ Project File holding the project info)
	Classes.sln  (The Solution File holding the solution info)
