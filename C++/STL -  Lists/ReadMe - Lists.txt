...
//		$Program:		Lists
//							 
//		$Description:	Demonstrates how to use STL's list class	 
//										 
//		$Date:		12/9/01			 
//				 
//*******************************************************************************//
...
Files:  	main.cpp (The Source File containing the actual code)
	Lists.vcproj  (The VC++ Project File holding the project info)
	Lists.sln  (The Solution File holding the solution info)
