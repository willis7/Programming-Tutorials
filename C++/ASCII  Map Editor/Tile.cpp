...
{
	// Okay, here is some trick my that allows us to take the background
	// color of image2 and apply it 2 image1.  Since the foreground and
	// background color is stored in 1 number, we need to do some binary 
