...
// the data which tells us information about the file, not the actuall data.  For
...
//
// This tutorial doesn't need to much explanation since not a lot was added, so
