...
//		$Program:		Inheritance
//											
//		$Description:	Lesson on multiple inheritance
//											
//		$Date:		10/11/01						
//											
//**********************************************************************************//

Files:  	main.cpp (The Source File containing the "main" code)
	damage.cpp (The Source File containing the "damage class implementation")
	player.cpp (The Source File containing the "players' implementation")
	player.h (The Header File containing the "players' definitions")
	damage.h (The Header File containing the "damage class definition")
	Inheritance.vcproj  (The VC++ Project File holding the project info)
	Inheritance.sln  (The Solution File holding the solution info)
