...
//		$Program:		FileReader
//									
//		$Description:	Shows how to read text from a .txt file 
//									
//		$Date:		10/28/01				
//									
//**********************************************************************************//
...
Files:  	main.cpp (The Source File containing the actual code)
	FileReader.vcproj  (The VC++ Project File holding the project info)
	FileReader.sln  (The Solution File holding the solution info)
	GT.txt  (The Text File for reading in and displaying)
