...
//		$Program:		Classes						
//											
//		$Description:	Explains the copy constructor and deconstructor 
//											
//		$Date:		6/10/01						
//											
//**********************************************************************************//
...
Files:  	main.cpp (The Source File containing the actual code)
	name.cpp (The Source File containing the "name's implementation")
	name.h (The Header File containing the "name's definitions")
