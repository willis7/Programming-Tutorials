...
//		$Program:		DirSearch
//										
//		$Description:	Prints a "specified file" to the screen (if found)	
//										
//		$Date:		9/24/01					
//										
//***********************************************************************//
...
Files:  	main.cpp (The Source File containing the actual code)
	DirSearch.vcproj  (The VC++ Project File holding the project info)
	DirSearch.sln  (The Solution File holding the solution info)
