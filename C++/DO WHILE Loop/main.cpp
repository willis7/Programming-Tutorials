...
int main()
{
	...
	// All we're going to do is repeatedly print out a line of text until the user presses
	// a key
	...
	} while(!kbhit());       /*	For starters what does kbhit() do?  This is a function
								that returns TRUE if any key on the keyboard has been pressed
								and FALSE otherwise -- Because this is in a do...while loop
								the printf() statement will necessarily execute at least once.
