...
//		$Program:		threads3					
//											
//		$Description:	Goes over "race conditions" with threading
//											
//		$Date:		9/15/03						
//											
//**********************************************************************************//
...
Files:  	main.cpp (The Source File containing the "main" code)
	threads3.vcproj  (The VC++ Project File holding the project info)
	threads3.sln  (The Solution File holding the solution info)
