...
//		$Program:		Templates						
//											
//		$Description:	Goes over templated classes
//											
//		$Date:		5/06/02						
//											
//**********************************************************************************//
...
Files:  	main.cpp (The Source File containing the actual code)
	point_tem.h (The Header File containing the "point class definition and implementation")
	Templates.vcproj  (The VC++ Project File holding the project info)
	Templates.sln  (The Solution File holding the solution info)
