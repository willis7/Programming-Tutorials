...
{	
	...
	// Attemp to initialze our class AND load the song.  If we fail to do so, quit the program
	...
	// Let get the name of the song first.  We do this by calling our data access function:
	...
	// It makes for cool demo's, like on the DarkSide demo at our site GameTutorials.com.
	// The channels that are playing are the amount of instruments being used in the song
	// currently.  Some songs you a lot, some songs might use 4 or 5.  If you are playing
...
// extention isn't important because the FMod library checks the actual file type.
...
// find much use for it.  I know I will be using it :)
//
// I hope this helps you make wonderfull applications!  All the credit goes to
