...
//		$Program:		Camera
//						 
//		$Description:	Introduction to a 3rd person camera
//											
//		$Date:		6/10/04							
//										 
//*********************************************************************************//
...
Files:	win_main.cpp  (The Source File containing the "window" code)
	...
	Camera.vcproj  (The VC++ Project File holding the project info)
	Camera.sln  (The Solution File holding the solution info)
