...
//		$Program:		FullScreen
//						 
//		$Description:	Shows how to toggle between windowed and full screen mode
//											
//		$Date:		10/04/04							
//										 
//*********************************************************************************//
...
Files:	win_main.cpp  (The Source File containing the "window" code)
	...
	FullScreen.vcproj  (The VC++ Project File holding the project info)
	FullScreen.sln  (The Solution File holding the solution info)
