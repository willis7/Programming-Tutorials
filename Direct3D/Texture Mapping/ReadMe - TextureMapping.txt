...
//						 
//		$Description:	An introduction to texture mapping with D3D
//											
//		$Date:		8/17/03							
//										 
//*********************************************************************************//
...
Files:	win_main.cpp  (The Source File containing the "window" code)
	...
	TextureMapping.vcproj  (The VC++ Project File holding the project info)
	TextureMapping.sln  (The Solution File holding the solution info)
	Texture.bmp (The BMP File to be displayed)
