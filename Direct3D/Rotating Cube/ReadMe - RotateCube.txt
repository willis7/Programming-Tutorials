...
//		$Program:		RotateCube
//						 
//		$Description:	Rotates a cube using D3D
//											
//		$Date:		7/19/03							
//										 
//*********************************************************************************//
...
Files:	win_main.cpp  (The Source File containing the "window" code)
	...
	RotateCube.vcproj  (The VC++ Project File holding the project info)
	RotateCube.sln  (The Solution File holding the solution info)
