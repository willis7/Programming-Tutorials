...
//		$Program:		Water
//						 
//		$Description:	Goes over a simple way to do a water effect
//											
//		$Date:		10/14/04							
//										 
//*********************************************************************************//
...
Files:	win_main.cpp  (The Source File containing the "window" code)
	...
	d3d_texture.cpp (The Source File containing the D3D texture code)
	water.cpp (The Souce File contianing the water object implementation)
	water.h (Header File containing the water object definition)
	d3d_texture.h (Header File containing the D3D texture definition)
	...
	Water.vcproj  (The VC++ Project File holding the project info)
	Water.sln  (The Solution File holding the solution info)
...
Instructions:	If you have Microsoft Visual Studio .NET (version 7.0) just click on the
		<Program Name>.vcproj file.  This will open up up visual c++.  You will most
