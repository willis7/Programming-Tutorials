...
//		$Program:		Lights
//						 
//		$Description:	An introduction to lighting in D3D
//											
//		$Date:		6/27/03							
//										 
//*********************************************************************************//
...
Files:	win_main.cpp  (The Source File containing the "window" code)
	...
	Lights.vcproj  (The VC++ Project File holding the project info)
	Lights.sln  (The Solution File holding the solution info)
