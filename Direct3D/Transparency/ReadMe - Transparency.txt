...
//						 
//		$Description:	An introduction to source and destination blending
//											
//		$Date:		8/6/03							
//										 
//*********************************************************************************//
...
Files:	win_main.cpp  (The Source File containing the "window" code)
	...
	Transparency.vcproj  (The VC++ Project File holding the project info)
	Transparency.sln  (The Solution File holding the solution info)
