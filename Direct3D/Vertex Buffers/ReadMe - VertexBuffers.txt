...
//						 
//		$Description:	An introduction to D3D vertex buffers
//											
//		$Date:		1/03/05							
//										 
//*********************************************************************************//
...
Files:	win_main.cpp  (The Source File containing the "window" code)
	...
	VertexBuffers.vcproj  (The VC++ Project File holding the project info)
	VertexBuffers.sln  (The Solution File holding the solution info)
