...
/*	
	...
	is a array of vertex data.  A more rounded definition would be, "A vertex buffer is a object
	which contains vertex data and properties which govern the vertex data".  For instance
	a D3D vertex buffer always you to set the memory management of the vertex buffer, which
	depending on the type you choose, can significantly improve performance.
...
#define class_name "GT_D3DVertexBuffers"
