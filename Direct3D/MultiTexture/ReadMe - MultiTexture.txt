...
//						 
//		$Description:	An introduction to multi-texturing with D3D
//											
//		$Date:		5/14/04							
//										 
//*********************************************************************************//
...
Files:	win_main.cpp  (The Source File containing the "window" code)
	...
	MultiTexture.vcproj  (The VC++ Project File holding the project info)
	MultiTexture.sln  (The Solution File holding the solution info)
	Lightmap, wall.bmp (The BMP Files used for multi-texturing)
