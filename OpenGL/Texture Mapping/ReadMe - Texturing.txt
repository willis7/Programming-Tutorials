...
Files:  	Main.cpp (The Source File containing the main program code)
	...
	Texturing.vcproj  (The VC++ Project File holding the project info)
	Texturing.sln  (The Solution File holding the solution info)
	Bitmap.bmp (The Bitmap File that is the texture map) 
