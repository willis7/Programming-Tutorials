...
Files:  	Main.cpp (The Source File containing the main program code)
	...
	3DMath.cpp (The Source File containing 3D math functions)
	3DMath.h (The Header File containing 3D math definitions)
	Main.h (The Header File containing definitions for the main program)
	ClosestPointOnPlane.vcproj  (The VC++ Project File holding the project info)
	ClosestPointOnPlane.sln  (The Solution File holding the solution info)
