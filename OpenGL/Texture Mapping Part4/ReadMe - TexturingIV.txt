...
//		$Program:		TexturingIV					 
//
//		$Description:	Texture maps a QUAD with a TARGA file
//											
//		$Date:		4/24/02							
//											
//*******************************************************************************
...
Files:  	Main.cpp (The Source File containing the main program code)
	...
	TexturingIV.vcproj  (The VC++ Project File holding the project info)
	TexturingIV.sln  (The Solution File holding the solution info)
	Image.tga (The TGA File that is the texture) 
