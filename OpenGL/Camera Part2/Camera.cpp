...
void CCamera::RotateView(float angle, float x, float y, float z)
{
	...
	// allows us to rotation a point in space around an arbitrary axis.  That means
	...
	// the math is larger than I want to write, I suggest checking our Paul Bourke's
	// page for an decent explanation of the math involved:  
...
// 
// The next tutorial will focus a bit more on camera, but more on adding to the
