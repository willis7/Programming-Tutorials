...
Files:  	Main.cpp (The Source File containing the main program code)
	...
	FramesPerSecond.vcproj  (The VC++ Project File holding the project info)
	FramesPerSecond.sln  (The Solution File holding the solution info)
