...
{	
	...
	hWnd = CreateMyWindow("First OpenGL Program", SCREEN_WIDTH, SCREEN_HEIGHT, 0, g_bFullScreen, hInstance);
...
// * QUICK NOTES * 
//
// Nothing new was added to this file concering this tutorial, except we took out
