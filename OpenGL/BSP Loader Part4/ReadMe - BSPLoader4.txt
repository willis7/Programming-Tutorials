...
//		$Program:	BSPLoader4
//
//		$Description:	This does basic collision with the BSP data		 
//			
//		$Date:		9/25/04	
//											
//****************************************************************************//
...
Files:  Main.cpp (The Source File containing the main program code)
	...
	BspLoader4.vcproj  (The VC++ Project File holding the project info)
	BspLoader4.sln  (The Solution File holding the solution info)
