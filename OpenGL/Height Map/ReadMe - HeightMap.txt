...
Files:  	Main.cpp (The Source File containing the main program code)
	...
	Terrain.cpp (The Source File containing the terrain rendering implementation)
	Terrain.h (The Header File containing "terrain" function defintions)
	...
	HeightMap.vcproj  (The VC++ Project File holding the project info)
	HeightMap.sln  (The Solution File holding the solution info)
