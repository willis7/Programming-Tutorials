...
Files:  	Main.cpp (The Source File containing the main program code)
	...
	MotionBlur.vcproj  (The VC++ Project File holding the project info)
	MotionBlur.sln  (The Solution File holding the solution info)
	Brick.bmp (The Bitmap File used as a texture map)
