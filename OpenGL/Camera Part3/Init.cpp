...
{	
	...
	hWnd = CreateMyWindow("www.GameTutorials.com - Camera Mouse Rotation", SCREEN_WIDTH, SCREEN_HEIGHT, 0, g_bFullScreen, hInstance);
...
// * QUICK NOTES * 
//
// The only thing different in this file is that we took out ShowCursor(TRUE) from
// the g_bFullScreen check and made it happen regardless, since we are using the mouse.
// 
//
