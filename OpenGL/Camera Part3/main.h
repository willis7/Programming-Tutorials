...
// * QUICK NOTES * 
//
// In this tutorial we added SetViewByMouse() to our CCamera class.  This is a
// need addition to our camera movement, especially if we want a first person view.
// The CVector3 class was pumped up too.  We can now have operator overloading!
//
//
