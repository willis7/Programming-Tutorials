...
Files:  	Main.cpp (The Source File containing the main program code)
	...
	Camera.cpp (The Source File containing camera class implementation)
	Camera.h (The Header File containing camera class definition)
	main.h (The Header File containing definitions for the main program)
	SkyBox.vcproj  (The VC++ Project File holding the project info)
	SkyBox.sln  (The Solution File holding the solution info)
	Back, Bottom, Front, Left, Right, Top.bmp (The Bitmap Files used for the skybox) 
