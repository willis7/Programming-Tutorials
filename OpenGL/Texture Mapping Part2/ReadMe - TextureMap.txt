...
//		$Program:		TextureMap
//										
//		$Description:	Shows you how to texture map without using glaux.lib
//											
//		$Date:		11/2/01							
//											
//*******************************************************************************//
...
Files:  	win_main.cpp (The Source File containing the main window code)
	...
	TextureMap.vcproj  (The VC++ Project File holding the project info)
	TextureMap.sln  (The Solution File holding the solution info)
	Texture.bmp (The Bitmap File that is the texture) 
