...
Files:  	Main.cpp (The Source File containing the main program code)
	...
	Quadrics.vcproj  (The VC++ Project File holding the project info)
	Quadrics.sln  (The Solution File holding the solution info)
	bitmap.bmp (The Bitmap File that is the texture map for the quadric) 
