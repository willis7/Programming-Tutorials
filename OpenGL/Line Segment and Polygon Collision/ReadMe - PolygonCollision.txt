...
Files:  	Main.cpp (The Source File containing the main program code)
	...
	3DMath.cpp (The Source File containing the 3D math functions)
	3DMath.h (The Header File containing the 3D math definitions)
	main.h (The Header File containing definitions for the main program)
	PolygonCollision.vcproj  (The VC++ Project File holding the project info)
	PolygonCollision.sln  (The Solution File holding the solution info)
