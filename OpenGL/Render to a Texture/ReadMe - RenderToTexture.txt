...
//						
//		$Description:	Demonstrates rendering to a texture map
//											
//		$Date:		2/27/02
//											
//*******************************************************************************
...
Files:  	Main.cpp (The Source File containing the main program code)
	...
	RenderToTexture.vcproj  (The VC++ Project File holding the project info)
	RenderToTexture.sln  (The Solution File holding the solution info)
	Brick.bmp (The Bitmap File that is used in the tutorial) 
