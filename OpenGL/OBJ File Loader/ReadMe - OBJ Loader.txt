...
Files:  	Main.cpp (The Source File containing the main program code)
	...
	Obj.cpp (The Source File containing the OBJ loader implementation)
	Obj.h (The Header File containing the OBJ loader definitions)
	main.h (The Header File containing definitions for the main program)
	Obj Loader.vcproj  (The VC++ Project File holding the project info)
	Obj Loader.sln  (The Solution File holding the solution info)
	Foot.obj (The OBJ model)
	bone.bmp (The Bitmap File that is the texture map for the model) 
