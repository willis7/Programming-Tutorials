...
{	
	...
	hWnd = CreateMyWindow("www.GameTutorials.com - Color", SCREEN_WIDTH, SCREEN_HEIGHT, 0, g_bFullScreen, hInstance);
...
//
// We didn't change anything in this tutorial except in RenderScene() which is in
// main.cpp.
//
//
