...
Files:  Main.cpp (The Source File containing the main program code)
	...
	VertexArrays.vcproj  (The VC++ Project File holding the project info)
	VertexArrays.sln  (The Solution File holding the solution info)
	Texture(1-4).bmp (The Bitmap Files that are used in the tutorial) 
