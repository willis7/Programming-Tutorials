...
Files:  	Main.cpp (The Source File containing the main program code)
	...
	BspLoader3.vcproj  (The VC++ Project File holding the project info)
	BspLoader3.sln  (The Solution File holding the solution info)
	...
	gfx Directory (Contains additional textures used by the application)
