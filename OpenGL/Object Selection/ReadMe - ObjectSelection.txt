...
Files:  	Main.cpp (The Source File containing the main program code)
	...
	ObjectSelection.vcproj  (The VC++ Project File holding the project info)
	ObjectSelection.sln  (The Solution File holding the solution info)
	Earth, Sun, Pluto.bmp (The Bitmap Files used as texture maps)
