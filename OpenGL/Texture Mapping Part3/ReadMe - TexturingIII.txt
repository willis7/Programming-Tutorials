...
//						
//		$Description:	Texture maps a QUAD with a JPEG
//											
//		$Date:		4/23/02							
//											
//*******************************************************************************
...
Files:  	Main.cpp (The Source File containing the main program code)
	...
	jpeglib.h (The Independent JPEG Group's Header File containing JPEG loading definitions)
	main.h (The Header File containing definitions for the main program)
	TexturingIII.vcproj  (The VC++ Project File holding the project info)
	TexturingIII.sln  (The Solution File holding the solution info)
	Image.jpg (The JPEG File that is the texture) 
...
Libraries:		opengl32.lib (The OpenGL Interface Library needed to compile the program)
		...
		jpeg.lib (The Independent JPEG Group's Library needed to compile the program)
