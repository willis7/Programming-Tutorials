...
bool CGLObj::init(HDC win_hdc, GLint colorBits, GLint depthBits)
{
	...
	// glBlendFunc() says how we want our particles to blend.  There's many different
	// ways you can have objects blend, but this particle blend mode says, "Take 
	// source color and blend it directly with the destination color for your resulting
	// color to put in the frame buffer".
	glEnable(GL_BLEND);
