...
Files:  	Main.cpp (The Source File containing the main program code)
	...
	3DS Animation.vcproj  (The VC++ Project File holding the project info)
	3DS Animation.sln  (The Solution File holding the solution info)
	Character.3DS (The 3DS animated character model)
	3ds Format.rtf (A text document that describes the 3DS file format)
	3dsAnimation.htm (A HTML document showing how to create an animated model in 3D Studio Max)
