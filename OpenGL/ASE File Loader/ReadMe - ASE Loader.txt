...
Files:  	Main.cpp (The Source File containing the main program code)
	...
	Ase.cpp (The Source File containg the ASE loading implementation)
	Ase.h (The Header File containing the ASE loading defintions)
	main.h (The Header File containing definitions for the main program)
	ASE Loader.vcproj  (The VC++ Project File holding the project info)
	ASE Loader.sln  (The Solution File holding the solution info)
	statue.ASE (The ASE model for displaying)
	marble.bmp (The BMP file that is the texture map for the statue.ASE model)
