...
//		$Program:		part1			
//									
//		$Description:	Sending and receiving (server part)
//									
//		$Date:		4/5/03				
//									
//***********************************************************************//
...
Files:  	server.cpp (The Source File containing the actual code)
	part1.vcproj  (The VC++ Project File holding the project info)
	part1.sln  (The Solution File holding the solution info)
