...
//		$Program:		part2			
//									
//		$Description:	Sending and receiving (client part)
//									
//		$Date:		4/5/03				
//									
//***********************************************************************//

Files:  	client.cpp (The Source File containing the actual code)
	part2.vcproj  (The VC++ Project File holding the project info)
	part2.sln  (The Solution File holding the solution info)
