...
//		$Program:		Questions			
//									
//		$Description:	Ask/Answer questions with "if/else statements"
//									
//		$Date:		6/5/00				
//									
//***********************************************************************//

Files:  	Questions.c  (The Source File containing the actual code)
	Questions.vcproj  (The VC++ Project File holding the project info)
	Questions.sln  (The Solution File holding the solution info)
