...
{											// This starts the main function
	...
	scanf("%d", &age);						// Read in the answer after the user hits return.
											...
											// The address is memory to the variable.  You give the function the address is memory by
	...
	}										// I also program for a language that REQUIRES it, but C/C++ is VERY flexible where there are
