...
//		$Program:		RandNum
// 
//		$Description:	Goes over how to generate random numbers	 
//			 
//		$Date:		1/28/02
//
//*******************************************************************************//
...
Files:  	main.c  (The Source File containing the actual code)
	RandNum.vcproj  (The VC++ Project File holding the project info)
	RandNum.sln  (The Solution File holding the solution info)
