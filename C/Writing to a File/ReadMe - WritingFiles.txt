...
//										
//		$Description:	Write player data numorous ways to a file
//										
//		$Date:		6/22/00		
//										
//**********************************************************************************//

Files:  	WritingFiles.c  (The Source File containing the actual code)
	WritingFiles.vcproj  (The VC++ Project File holding the project info)
	WritingFiles.sln  (The Solution File holding the solution info)
