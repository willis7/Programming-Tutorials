...
//		$Program:		WhileLoop
//									
//		$Description:	Goes over the "while loop" 
//									
//		$Date:		10/26/01				
//									
//**********************************************************************************//
...
Files:  	main.c  (The Source File containing the actual code)
	WhileLoop.vcproj  (The VC++ Project File holding the project info)
	WhileLoop.sln  (The Solution File holding the solution info)
