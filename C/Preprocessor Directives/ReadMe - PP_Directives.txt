...
//										
//		$Program:		PP_Directives
//										
//		$Description:	Discusses preprocessor directives		
//										
//		$Date:		9/12/01					
//										
//***********************************************************************//
...
Files:  	main.c (The Source File containing the actual code)
	PP_Directives.vcproj  (The VC++ Project File holding the project info)
	PP_Directives.sln  (The Solution File holding the solution info)
