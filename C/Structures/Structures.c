...
void main()
{
	...
	printf("The change comes out to %d dollars and %.2f cents.\n", Change2.Dollars, Change2.Cents);
														...
														// There is more, like binary and hexadecimal representations, but I don't remember them off hand, and I have never used them except for assignments in school.
}
