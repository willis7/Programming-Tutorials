...
//		$Program:		Structures		
//									
//		$Description:	Simple use of structures
//									
//		$Date:		7/10/00		
//									
//***********************************************************************//

Files:  	Structures.c  (The Source File containing the actual code)
	Structures.vcproj  (The VC++ Project File holding the project info)
	Structures.sln  (The Solution File holding the solution info)
