...
//		$Program:		Recursion
//										
//		$Description:	Ahhh... It goes over recursion :)	
//										
//		$Date:		8/26/01					
//										
//***********************************************************************//
...
Files:  	main.c	(The Source File containing the actual code)
	Recursion.vcproj  (The VC++ Project File holding the project info)
	Recursion.sln  (The Solution File holding the solution info)
