...
#define DRAW  1										// Or DRAW the player to the screen.  This makes it so we don't need to make 2 functions for drawing and erasing.
													...
													// Let me explain the syntax for sec, "typedef" means we are "defining a type"
													...
													// Also, the CAPS on the PLAYER doesn't matter either, it's just preference. let's you know it's a typedef.. most people do this.
...
void DrawPlayer(PLAYER Player, int Draw);			// Here we declare our function to draw the player.  You'll notice that we have a PLAYER structure to pass in, as well as a flag.
													...
													// Now comes the crazy part.  POINTERS!!!!  NO!!!
...
// Does this make a little more sense?  If not, I have a good tutorial using pointers in very simple to understand ways.
