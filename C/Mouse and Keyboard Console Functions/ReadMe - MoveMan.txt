...
Files:  	MoveMan.c (The Source File containing the actual code)
	MoveMan.h (The Header File containing defines and function definitions)
	MoveMan.vcproj  (The VC++ Project File holding the project info)
	MoveMan.sln  (The Solution File holding the solution info)
