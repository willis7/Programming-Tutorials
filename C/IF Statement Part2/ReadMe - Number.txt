...
//		$Program:		Number
//									
//		$Description:	Goes over "if", "else if" and "else"
//									
//		$Date:		11/5/01				
//									
//*******************************************************************************//
...
Files:  	main.c  (The Source File containing the actual code)
	Number.vcproj  (The VC++ Project File holding the project info)
	Number.sln  (The Solution File holding the solution info)
