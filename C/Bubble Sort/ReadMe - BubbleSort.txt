...
//		$Program:		BubbleSort
//
//		$Description:	Goes over the "bubble sort" sorting method	 
// 
//		$Date:		12/16/01
//					
//*******************************************************************************//
...
Files:  	main.c  (The Source File containing the actual code)
	BubbleSort.vcproj  (The VC++ Project File holding the project info)
	BubbleSort.sln  (The Solution File holding the solution info)
