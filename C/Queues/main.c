...
/* Okay all the good green stuff (the explanations) are in Queue.h and Queue.c
   ...
   then pritn them to the screen as we remove them from the queue --
*/
...
/*	Extra chatter...
	...
	It's intent is just to get you familar on the high level concept of a queue and show you
	a possible implementation (although very primiate) -- Generally the functions/menthods 
