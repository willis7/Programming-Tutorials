...
//		$Program:		Queues
//										
//		$Description:	Discusses the concept of a "queue"	
//										
//		$Date:		7/18/01					
//										
//***********************************************************************//
...
Files:  	main.c (The Source File containing the actual code)
	Queue.c (The Source File containing the "queue's implementation")
	Queue.h (The Header File containing the "queue's definitions")
	Queues.vcproj  (The VC++ Project File holding the project info)
	Queues.sln  (The Solution File holding the solution info)
