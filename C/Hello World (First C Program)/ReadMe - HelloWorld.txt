...
Files:  	HelloWorld.c (The Source File containing the actual code)
	HelloWorld.vcproj  (The VC++ Project File holding the project info)
	HelloWorld.sln  (The Solution File holding the solution info)
