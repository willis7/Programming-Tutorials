...
//		$Program:		Binary				
//										
//		$Description:	Talks about the binary operators, "and", "or", and "xor"	
//										
//		$Date:		7/18/01					
//										
//***********************************************************************//
...
Files:  	main.c (The Source File containing the actual code)
	Binary.vcproj  (The VC++ Project File holding the project info)
	Binary.sln  (The Solution File holding the solution info)
