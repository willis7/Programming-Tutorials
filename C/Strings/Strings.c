...
{											// This starts the main function
	char szAnswer[25] = {0};				// You've seen these before!  This is declaring a string.
											// If we did not have the [25] at the end it would just be a character.
											// We wouldn't need the [25] if we were just asking 'y' or 'n' questions.
											...
											// Again, a variable is name that points to a place in memory.  Instead of 
											...
											// But I am trying to be as CLEAR as possible.  I wish someone had tutorials like these
											// Back when I was starting programming.  Now days some are better, but not like this :)
											// ONE more thing about this line is, there is an " = {0}"  .
											// When you have a string, this is the way of initializing it.  If we didn't, it would look like this:
											// "            "IIIIIIIIIIIIIIIIIIIIIIIIIIIII8be"    "    if you printed it out.  (basically 25 characters of junk)
											// This is the address of the variable in memory... I don't know why Microsoft didn't auto initialize it.
	...
	scanf("%s", szAnswer);					// Since we are reading in a string, we must use "%s".  Pass in szAnswer to hold the answer.
											// Here is a tricky statement to look at.
	...
	scanf("%s", szAnswer);					// Get the answer again.
											...
											// Before you can full understand how this works, let me explain how strings work.
											...
											// This thing lets the compiler know the string's end.  let me explain why.
											// We create a string of 25 characters right?  at the beginning?  SO!
											...
											// By the way, I chose [25] for the amount of characters because it just seems like a decent number.
											// Just in case you want to type something more than "yes" or "no"...  realistically we
											// Would only need like [3]. or maybe even 1 if we are just checking the first character they type in.
	...
	{										// Encourage them :)
		printf("Don't worry, if it seems frustrating now, it will become more clear.\n");
											...
											// Even numbers.  like "num"  .  num[0] = 2;  is the same thing as num = 2;
