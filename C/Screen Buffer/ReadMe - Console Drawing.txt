...
//									
//		$Program:		ConsoleDrawing			
//									
//		$Description:	Creates a screen buffer
//									
//		$Date:		6/29/01				
//									
//***********************************************************************//

Files:  	ConsoleDrawing.c    (The Source File containing the actual code)
	ConsoleDrawing.vcproj  (The VC++ Project File holding the project info)
	ConsoleDrawing.sln  (The Solution File holding the solution info)
