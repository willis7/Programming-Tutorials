...
int main()
{
	...
	// These are the two character buffers (strings) that we'll use for 
	// user input
	char str1[STR_MAX] = {0};
	char str2[STR_MAX] = {0};
	...
	// The strlen() function does what you'd expect, it gives you number of characters
	...
	// (stop that thought right now you pervert %)
	...
	// For the sake of clarity, lets break down the sprintf() function:
	...
	*/
	...
	// Now lets concatenate str2 onto buffy
	...
	*/
	...
	// Now lets check to see if "str1" and "str2" are equal -- By equal we mean
	...
	*/
	...
	// Finally, lets print out whether "str1" is contained within "str2"
...
*************************************************************************************
	...
	//	in "buffer" this does NOT count the NULL character.
...
*************************************************************************************
	...
	// and is case sensitve) the return value is ZERO -- Otherwise it returns some
	// other number 
...
*************************************************************************************
  ...
  char* strstr(const char *searchMe, const char *str2SearchFor);
	...
	// is this function searchs "searchMe" for the smaller string "str2SearchFor"
	// If it finds an occurence of "str2SearchFor" in "searchMe" it returns a
