...
//		$Program:		Strings				
//										
//		$Description:	Goes over multiple string functions		
//										
//		$Date:		7/5/02					
//										
//*******************************************************************************//
...
Files:  	main.c (The Source File containing the actual code)
	Strings.vcproj  (The VC++ Project File holding the project info)
	Strings.sln  (The Solution File holding the solution info)
