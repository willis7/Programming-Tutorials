...
//		$Program:		Arrays				
//										
//		$Description:	An array overview		
//										
//		$Date:		6/1/01			
//										
//***********************************************************************//

Files:  	Array.c	(The Source File containing the actual code)
	Arrays.vcproj  (The VC++ Project File holding the project info)
	Arrays.sln  (The Solution File holding the solution info)
