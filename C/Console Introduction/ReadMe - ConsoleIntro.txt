...
//										
//		$Description:	An introduction to "console" Win32 functions/data types	
//										
//		$Date:		10/26/03					
//										
//***********************************************************************//
...
Files:  	main.c (The Source File containing the actual code)
	Functions.vcproj  (The VC++ Project File holding the project info)
	Functions.sln  (The Solution File holding the solution info)
