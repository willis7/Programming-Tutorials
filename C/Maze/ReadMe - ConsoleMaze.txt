...
//		$Program:		ConsoleMaze		
//									
//		$Description:	Makes a simple maze
//									
//		$Date:		6/30/01				
//									
//***********************************************************************//

Files:  	ConsoleMaze.c    (The Source File containing the actual code)
	ConsoleMaze.vcproj  (The VC++ Project File holding the project info)
	ConsoleMaze.sln  (The Solution File holding the solution info)
