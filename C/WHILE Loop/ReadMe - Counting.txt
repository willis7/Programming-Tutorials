...
//		$Program:		Counting			
//									
//		$Description:	Prints a number range to the screen using a "while loop"
//									
//		$Date:		6/5/00				
//									
//***********************************************************************//

Files:  	Counting.c    (The Source File containing the actual code)
	Counting.vcproj  (The VC++ Project File holding the project info)
	Counting.sln  (The Solution File holding the solution info)
