...
//		$Program:		Precedence
//										
//		$Description:	Goes over mathamatical operator precedence in C	
//										
//		$Date:		9/3/01					
//										
//***********************************************************************//
...
Files:  	main.c (The Source File containing the actual code)
	Precedence.vcproj  (The VC++ Project File holding the project info)
	Precedence.sln  (The Solution File holding the solution info)
