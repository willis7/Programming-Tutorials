...
//		$Program:		QSort
//				 
//		$Description:	Goes over the qsort() function	 
//			 
//		$Date:		12/16/01
//						 
//*******************************************************************************//
...
Files:  	main.c  (The Source File containing the actual code)
	QSort.vcproj  (The VC++ Project File holding the project info)
	QSort.sln  (The Solution File holding the solution info)
