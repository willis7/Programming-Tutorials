...
//		$Program:		Malloc			
//									
//		$Description:	Goes over allocating memory
//									
//		$Date:		7/11/01				
//									
//***********************************************************************//
...
Files:  	main.c (The Source File containing the actual code)
	Malloc.vcproj  (The VC++ Project File holding the project info)
	Malloc.sln  (The Solution File holding the solution info)
