...
//		$Program:		Switch		 
//
//		$Description:	Goes over switch statements.	 
//
//		$Date:		5/18/00			 
//
//*************************************************************************//
...
Files:  	Switch.c    (The Source File containing the actual code)
	Switch.vcproj  (The VC++ Project File holding the project info)
	Switch.sln  (The Solution File holding the solution info)
