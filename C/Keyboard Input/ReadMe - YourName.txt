...
Files:  	YourName.c (The Source File containing the actual code)
	YourName.vcproj  (The VC++ Project File holding the project info)
	YourName.sln  (The Solution File holding the solution info)
