...
int main()
{
	...
	swap_correct(&num1,&num2);				/* What is with the & in front of num1 and num2
											   Remember are function declaration looked like
											   this void swap_correct(int *num1, int *num2);
...
// of typing the two printf() statements everywhere -- I can know just call this function
void disp_numbers(int num1, int num2)
{
	printf("num1 = %d\n",num1);
	printf("num2 = %d\n",num2);
