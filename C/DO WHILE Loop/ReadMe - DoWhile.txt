...
//		$Program:		DoWhile				
//										
//		$Description:	Goes over the Do While Loop		
//										
//		$Date:		6/3/01					
//										
//***********************************************************************//
...
Files:  	main.c	(The Source File containing the actual code)
	DoWhile.vcproj  (The VC++ Project File holding the project info)
	DoWhile.sln  (The Solution File holding the solution info)
