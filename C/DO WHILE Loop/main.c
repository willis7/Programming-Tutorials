...
/*	This tutorial is going to cover the do while loop.  Do while loops are very similar to
	...
	**NOTE**  The command break, goto or return
		      ...
		      following the loop) a do while loop.

*/

// This main is pretty simply.  We're going to declare an integer and WHILE it's value is less
...
int main()
{
	...
	{
		printf("%d\n",num); // This prints "num" to the screen and then advances to the 
							// next line 
						    // **NOTE**	The "\n" works just like pressin "Enter" in NotePad
		...
		num++;				// The "++" increments num by one.  So if num equalled 6, after 
							// the line of code num++; was exectued, num would equal 7.
...
// Doing it, and doing it and doing it while....
