...
//		$Program:		Pointers						
//											
//		$Description:	A tutorial on function pointers
//											
//		$Date:		10/8/01						
//											
//**********************************************************************************//
...
Files:  	main.c  (The Source File containing the actual code)
	Pointers.vcproj  (The VC++ Project File holding the project info)
	Pointers.sln  (The Solution File holding the solution info)
