...
//										
//		$Description:	Goes over what a "conditional statement" is	
//										
//		$Date:		6/13/01					
//										
//***********************************************************************//
...
Files:  	main.c	(The Source File containing the actual code)
	Conditional Statements.vcproj  (The VC++ Project File holding the project info)
	Conditional Statements.sln  (The Solution File holding the solution info)
