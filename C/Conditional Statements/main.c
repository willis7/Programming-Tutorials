...
/*	What are conditional statements?  Well they're statements (more like a sequence of characters)
	...
	For instance lets say you had a program where you had two dice.  You wanted to test
...
int main()
{
	...
	/* I'm not going to really comment anything here in the main() -- Look 
	   ...
	   and see if you KNOW what is going to be printed
		...
		I suggest these combinations (but make up you own if you want :)
...
// Okay you now have the LOGIC CONDITIONAL STATEMENTS (operators) down pat --
// As always, any questions, comments, concerns post 'em at www.GameTutorials.com
