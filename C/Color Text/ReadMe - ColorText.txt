...
//		$Program:		ColorText			
//									
//		$Description:	Draws text to the screen in color.
//									
//		$Date:		6/20/00				
//									
//***********************************************************************//

Files:  	ColorText.c    (The Source File containing the actual code)
	ColorText.vcproj  (The VC++ Project File holding the project info)
	ColorText.sln  (The Solution File holding the solution info)
