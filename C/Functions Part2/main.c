...
// Here we are DEFINIG OUR FUNCTION PROTOTYPE -- It will return an integer (the resulting
...
int power(int base, int exp) // **Notice NO SEMI-COLON
{
	...
	int result = 1; // This is local variable -- IT IS ONLY KNOW to the function
...
/* Rule of thumb:
	...
	Now these functions, for example init_game(), could be broken down into even more functions.
	Such as:
