...
#define MAX_NUMBERS 15						// This is called a define.  Usually the #defines go after the includes.
											...
											// Find and replace in ALL 50 files?  It's SOoOoOooO time consuming a tedious.  I learned the hard way :)
											// You can also use defines like this:
											// "#define PRINT_SCORE(score) printf("Your score is %d.\n", score);
											// If I type PRINT_SCORE(<a variable>) anywhere, it will substitute the printf function and print the value of the variable passed in.
											// Like this: PRINT_SCORE(<a integer>) printf("Your score is %d.\n", <a integer>); .  
											...
											// They are HARD to trace.  Also, I don't think they check syntax when you compile, so it could give you an
											// Error that you have no idea where it came from on run-time (when the program is running).
...
{											// This starts the main function
	...
	{											
		list[i] = rand() % 100;				// Randomize the new list with numbers less than 100.
											...
											// Here is an example on how modulus works.  It kinda like divide.
											// "  15 % 5 = 0,      15 % 7 = 1,    15 % 26 = 15 "
											// Can you see why?  it's the remainder.  15 / 5 = 3 with NO remainder, so 15 % 5 = 0
											// 15 / 7 has a remainder of 1.  Anything over 15 will return a remainder of 15. (i don't know why either :) )
