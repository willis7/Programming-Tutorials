...
//		$Program:		PlaySound
//								
//		$Description:	This shows 2 different ways to play sound files
//									
//		$Date:		6/25/00		
//									
//***********************************************************************//

Files:  	PlaySound.c  (The Source File containing the actual code)
	PlaySound.vcproj  (The VC++ Project File holding the project info)
	PlaySound.sln  (The Solution File holding the solution info)
	mysound.wav (A Sound File to be played)
	mysound2.wav (A Sound File to be played)

Libraries:		winmm.lib (The Windows Multimedia Library needed to compile the program)
