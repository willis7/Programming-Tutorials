...
//										
//		$Description:	Read in player data in numorous ways		
//										
//		$Date:		6/20/00					
//										
//**********************************************************************************//

Files:  	ReadingFiles.c    (The Source File containing the actual code)
	ReadingFiles.vcproj  (The VC++ Project File holding the project info)
	ReadingFiles.sln  (The Solution File holding the solution info)
	Stats.txt (The Text File for reading)
