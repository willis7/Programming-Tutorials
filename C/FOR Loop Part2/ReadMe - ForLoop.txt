...
//		$Program:		ForLoop
//									
//		$Description:	Prints "Hello World" ten times using a "for loop"
//									
//		$Date:		10/23/01				
//									
//***********************************************************************//
...
Files:  	main.c  (The Source File containing the actual code)
	ForLoop.vcproj  (The VC++ Project File holding the project info)
	ForLoop.sln  (The Solution File holding the solution info)
