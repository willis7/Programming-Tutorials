...
//		$Program:		Stacks						
//											
//		$Description:	Defines a stack -- Implements a stack
//											
//		$Date:		6/9/01						
//											
//**********************************************************************************//

Files:  	main.c        (Another Source File containing code)
	stack.c    (The Source File containing the actual code)
	stack.h    (The Header File containing the definitions)
	Stacks.vcproj  (The VC++ Project File holding the project info)
	Stacks.sln  (The Solution File holding the solution info)
